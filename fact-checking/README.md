...
1. Review the checklist regularly
2. Research each claim with multiple credible sources
3. Document your findings with sources
4. Update the checklist as items are verified
5. Flag any discrepancies for team review

## Contributing

If you find a claim in HAIEF documentation that seems questionable or needs verification, please:

1. [Submit a fact-check request via the online form](https://haief-site.pages.dev/submit-fact-check/)
